Write a simple program that tells a story about not being greedy.
...
#include <stdio.h>
int main(void){
	printf("Title It Is Not Good To Be Gready \n");
	printf("Author: Monsuru Muadh Adekunle \n");
	printf("Matric Number: FUO/22/0353 \n");
